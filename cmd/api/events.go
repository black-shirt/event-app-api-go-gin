...
import (
	...
	"github.com/black-shirt/event-app-go-gin/internal/database"
...
func (app *application) updateEvent(c *gin.Context) {
	...
	if existingEvent.OwnerId != user.Id {
		c.JSON(http.StatusForbidden, gin.H{"error": "You are not authoried to update this event"})
	}
...
func (app *application) addAttendeeToEvent(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Faile to retreive event"})
		return
	}
	...
	if existingAttendee != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": "Attendee already exists"})
		return
	}
...
func (app *application) deleteAttendeeFromEvent(c *gin.Context) {
	...
	user := app.GetUserFromContext(c)
	if event.OwnerId != user.Id {
		c.JSON(http.StatusForbidden, gin.H{"error": "You are not authorizedto delete and attendee from this event"})
	}
